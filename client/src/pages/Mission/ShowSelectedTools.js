...
const ShowSelectedTools = () => {
  ...
  return (
    ...
    <div>
      ...
      <Card.Img variant="top" style={{ width: '8rem', padding: "5px" }} src={data.tool_img} />
      <Card.Body>
        <Card.Title style={{ fontSize: '.90rem', textAlign: "center", backgroundColor: "#4AB8DF", textAlign: "center", }}>{data.tool_name}</Card.Title>
